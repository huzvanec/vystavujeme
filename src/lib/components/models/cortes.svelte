...
Command: npx @threlte/gltf@3.0.0 /home/lukas/webstorm-projects/voyager/models/cortes.glb --transform --resolution 4096 --types --suspense
-->
...
<script lang="ts">
	...
	const gltf = suspend(useGltf<GLTFResult>('/cortes-transformed.glb'));
</script>
